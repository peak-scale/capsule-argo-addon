...
// Validates configuration before it's applied as status and transfered to the store
// If validation fails, the configuration is not applied
func (r *ConfigReconciler) validateSettings(ctx context.Context, client client.Client, origin *addonsv1alpha1.ArgoAddonSpec) error {
