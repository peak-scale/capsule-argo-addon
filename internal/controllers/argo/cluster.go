...
func (i *TenancyController) reconcileArgoCluster(ctx context.Context, log logr.Logger, tenant *capsulev1beta2.Tenant, token string) error {
	...
	url, _ := i.proxyService(ctx, tenant)
