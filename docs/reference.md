...
<table>
    ...
    <tbody><tr>
        <td><b>serviceAccountClusterRoles</b></td>
        <td>[]string</td>
        <td>
          ClusterRoles assigned to serviceaccounts generated by the addon and added as owners to the capsule tenant<br/>
          <br/>
            <i>Default</i>: [admin capsule-namespace-deletor]<br/>
        </td>
        <td>true</td>
      </tr><tr>
