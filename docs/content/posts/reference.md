...
### ArgoAddon.spec.translatorSelector
...
| **Name** | **Type** | **Description** | **Required** |
| :---- | :---- | :----------- | :-------- |
| **[matchExpressions](#argoaddonspectranslatorselectormatchexpressionsindex)** | []object | matchExpressions is a list of label selector requirements. The requirements are ANDed. | false |
...
### ArgoAddon.spec.translatorSelector.matchExpressions[index]
...
### ArgoAddon.status.loaded.translatorSelector
...
| **Name** | **Type** | **Description** | **Required** |
| :---- | :---- | :----------- | :-------- |
| **[matchExpressions](#argoaddonstatusloadedtranslatorselectormatchexpressionsindex)** | []object | matchExpressions is a list of label selector requirements. The requirements are ANDed. | false |
| **matchLabels** | map[string]string | matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
map is equivalent to an element of matchExpressions, whose key field is "key", the
operator is "In", and the values array contains only "value". The requirements are ANDed. | false |


### ArgoAddon.status.loaded.translatorSelector.matchExpressions[index]
...
| **[clusterResourceBlacklist](#argotranslatorspecsettingsstructuredclusterresourceblacklistindex)** | []object | ClusterResourceBlacklist contains list of blacklisted cluster level resources | false |
| **[clusterResourceWhitelist](#argotranslatorspecsettingsstructuredclusterresourcewhitelistindex)** | []object | ClusterResourceWhitelist contains list of whitelisted cluster level resources | false |
| **description** | string | Description contains optional project description | false |
| **[destinations](#argotranslatorspecsettingsstructureddestinationsindex)** | []object | Destinations contains list of destinations available for deployment | false |
| **finalizers** | []string | Finalizers for the project | false |
| **labels** | map[string]string | Labels for the project | false |
| **[namespaceResourceBlacklist](#argotranslatorspecsettingsstructurednamespaceresourceblacklistindex)** | []object | NamespaceResourceBlacklist contains list of blacklisted namespace level resources | false |
| **[namespaceResourceWhitelist](#argotranslatorspecsettingsstructurednamespaceresourcewhitelistindex)** | []object | NamespaceResourceWhitelist contains list of whitelisted namespace level resources | false |
| **[orphanedResources](#argotranslatorspecsettingsstructuredorphanedresources)** | object | OrphanedResources specifies if controller should monitor orphaned resources of apps in this project | false |
...
| **[roles](#argotranslatorspecsettingsstructuredrolesindex)** | []object | Roles are user defined RBAC roles associated with this project | false |
| **[signatureKeys](#argotranslatorspecsettingsstructuredsignaturekeysindex)** | []object | SignatureKeys contains a list of PGP key IDs that commits in Git must be signed with in order to be allowed for sync | false |
...
| **[syncWindows](#argotranslatorspecsettingsstructuredsyncwindowsindex)** | []object | SyncWindows controls when syncs can be run for apps in this project | false |


### ArgoTranslator.spec.settings.structured.clusterResourceBlacklist[index]
...
### ArgoTranslator.spec.settings.structured.clusterResourceWhitelist[index]
...
### ArgoTranslator.spec.settings.structured.destinations[index]
...
### ArgoTranslator.spec.settings.structured.namespaceResourceBlacklist[index]
...
### ArgoTranslator.spec.settings.structured.namespaceResourceWhitelist[index]
...
### ArgoTranslator.spec.settings.structured.orphanedResources
...
| **Name** | **Type** | **Description** | **Required** |
| :---- | :---- | :----------- | :-------- |
| **[ignore](#argotranslatorspecsettingsstructuredorphanedresourcesignoreindex)** | []object | Ignore contains a list of resources that are to be excluded from orphaned resources monitoring | false |
| **warn** | boolean | Warn indicates if warning condition should be created for apps which have orphaned resources | false |


### ArgoTranslator.spec.settings.structured.orphanedResources.ignore[index]
...
### ArgoTranslator.spec.settings.structured.roles[index]
...
| **[jwtTokens](#argotranslatorspecsettingsstructuredrolesindexjwttokensindex)** | []object | JWTTokens are a list of generated JWT tokens bound to this role | false |
...
### ArgoTranslator.spec.settings.structured.roles[index].jwtTokens[index]
...
### ArgoTranslator.spec.settings.structured.signatureKeys[index]
...
### ArgoTranslator.spec.settings.structured.syncWindows[index]
...
| **Name** | **Type** | **Description** | **Required** |
| :---- | :---- | :----------- | :-------- |
| **[conditions](#argotranslatorstatusconditionsindex)** | []object | Conditions represent the latest available observations of an object's state | false |
