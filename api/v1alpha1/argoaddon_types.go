...
type ControllerArgoCDConfig struct {
	...
	// ClusterRoles assigned to serviceaccounts generated by the addon and added as owners to the capsule tenant
	// +kubebuilder:default={admin,capsule-namespace-deletor}
	ServiceAccountClusterRoles []string `json:"serviceAccountClusterRoles"`
}
