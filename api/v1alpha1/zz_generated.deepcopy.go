...
func (in *ArgoAddonSpec) DeepCopyInto(out *ArgoAddonSpec) {
	*out = *in
	...
	in.TranslatorSelector.DeepCopyInto(&out.TranslatorSelector)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ArgocdProjectStructuredPropertiesOld) DeepCopyInto(out *ArgocdProjectStructuredPropertiesOld) {
	*out = *in
	in.ProjectMeta.DeepCopyInto(&out.ProjectMeta)
	...
	if in.SyncWindows != nil {
		...
		*out = make([]applicationv1alpha1.SyncWindows, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = make(applicationv1alpha1.SyncWindows, len(*in))
				for i := range *in {
					if (*in)[i] != nil {
						in, out := &(*in)[i], &(*out)[i]
						*out = new(applicationv1alpha1.SyncWindow)
						(*in).DeepCopyInto(*out)
					}
				}
			}
	...
	if in.Destinations != nil {
		...
		*out = make([]applicationv1alpha1.ApplicationDestination, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArgocdProjectStructuredPropertiesOld.
func (in *ArgocdProjectStructuredPropertiesOld) DeepCopy() *ArgocdProjectStructuredPropertiesOld {
	if in == nil {
		return nil
	}
	out := new(ArgocdProjectStructuredPropertiesOld)
	in.DeepCopyInto(out)
	return out
}
