...
func (in *ArgoTranslatorSpec) DeepCopyInto(out *ArgoTranslatorSpec) {
	*out = *in
	...
	if in.ProjectSettings != nil {
		in, out := &in.ProjectSettings, &out.ProjectSettings
...
func (in *ArgocdProjectStructuredProperties) DeepCopyInto(out *ArgocdProjectStructuredProperties) {
	*out = *in
	if in.ProjectMeta != nil {
		in, out := &in.ProjectMeta, &out.ProjectMeta
		*out = new(ArgocdProjectPropertieMeta)
		(*in).DeepCopyInto(*out)
	}
...
func (in *ControllerArgoCDConfig) DeepCopyInto(out *ControllerArgoCDConfig) {
	*out = *in
	if in.ServiceAccountClusterRoles != nil {
		in, out := &in.ServiceAccountClusterRoles, &out.ServiceAccountClusterRoles
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
